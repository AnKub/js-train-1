...
function isPositiveNumber(num) {
  return "This is " + (num>=0 ? true : false);
}
...
function getUserStatus(age) {
  if (age<18) {
    ...
    return console.log('I can tell you where the nearest pharmacy is.');
    }
    }
  ...
  switch (dayNumber) {
   ...
   case 7:
    console.log  ("Воскресенье");
        break;
  default:
    console.log('we have only 7 days');
}
}
...
function getVariableType(variable) {
 ...
 type === 'string' ?
  ...
  type === 'boolean' ?
  'this is a Boo' : 
  'This is... dont know what is this'
  return result;
